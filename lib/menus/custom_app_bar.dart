...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  // final bool canGoBack; // REMOVED: No longer needed here
  // final VoidCallback? onBackButtonPressed; // REMOVED: No longer needed here

  const CustomAppBar({
    super.key,
    required this.onMenuPressed,
    required this.onSearchPressed,
    // this.canGoBack = false, // REMOVED
    // this.onBackButtonPressed, // REMOVED
  });
